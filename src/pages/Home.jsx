     ...
     <>
      ...
      <div className="flex flex-col items-center justify-center flex-1 min-h-full bg-[var(--white)] z-10">
          ...
          <div className="mt-30 flex flex-col justify-center items-center whitespace-nowrap mb-5">
              ...
              <span className=" text-[24px] font-vagrounded font-semibold">Build Your Form </span>
               <span className="text-[24px] font-vagrounded font-black"> INSTANTLY!</span> 
        ...
        <span className="mt-10 bottom font-zendots font-semibold text-[12px]"> by C-men</span>
        <AnimatePresence>
          {showModal && (
            <motion.div
              key="modal"
